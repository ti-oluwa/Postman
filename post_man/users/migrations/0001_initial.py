    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_idno', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='User ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_key', models.CharField(editable=False, max_length=20)),
                ('is_active', models.BooleanField(default=True)),
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('owned_by', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='profile owner')),
            ],
        ),
        migrations.CreateModel(
            name='EmailProfile',
            fields=[
                ...
                ('app_pass', models.CharField(editable=False, max_length=20)),
